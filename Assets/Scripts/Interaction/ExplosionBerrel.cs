...
public class ExplosionBerrel : InteractionObjects
{
    [Header("Explosion Berrel")] [SerializeField]
    ...
    private IEnumerator ExplodeBarrel()
    {
        ...
        foreach (Collider hit in colliders)
        {
            ...
            InteractionObjects interactionObj = hit.GetComponent<InteractionObjects>();
            if (interactionObj != null)
            {
                interactionObj.TakeDamage(300);
            }
